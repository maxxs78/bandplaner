...
- Persönliche Kennzeichnung einzelner Setlist-Einträge je Mitglied: individuelle Farbe, kurze Notiz sowie Bühnen-Hinweis-Icons — Umstimmen, Instrumentwechsel (wahlweise direkt mit einem Equipment-Katalogeintrag der Kategorie „Instrumente" verknüpft statt Freitext, siehe 3.9), Equipment (dieselbe Verknüpfung für sonstiges Equipment wie PA, Amps/Pedalboard, Zubehör), Programmwechsel mit Programmnummer, Kapo, Klick, Loop-Pedal, Backing Vocal, Solo, Einzähler, In-Ear sowie freier Hinweis. Jeder Hinweistyp lässt sich je Eintrag beliebig oft anwenden (z. B. zwei Instrumentwechsel innerhalb eines Songs). Nur für das jeweilige Mitglied sichtbar und unabhängig von den bandweiten Songdaten. Trägt der verknüpfte Equipment-Katalogeintrag ein Icon und eine Farbe, lässt sich je Setlist wählen, ob dieses Icon klein im Hinweis-Badge, groß neben Tonart/BPM oder gar nicht dargestellt wird.
